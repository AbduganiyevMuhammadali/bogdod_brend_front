...
const icons = {
  ...
  'refresh-cw':  `<polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 11-2.12-9.36L23 10"/>`,
  ...
  building:   `<rect x="4" y="2" width="16" height="20"/><rect x="9" y="22" width="6" height="0"/><line x1="4" y1="6" x2="20" y2="6"/><line x1="4" y1="10" x2="20" y2="10"/><line x1="4" y1="14" x2="20" y2="14"/><line x1="4" y1="18" x2="20" y2="18"/><rect x="8" y="2" width="8" height="4"/>`,
  ...
  phone:      `<path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81 19.79 19.79 0 01.1 2.18 2 2 0 012.1.02h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.18 7.91a16 16 0 006.16 6.16l1.08-1.08a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7a2 2 0 011.72 2.03z"/>`,
  ...
  'image-off':`<line x1="2" y1="2" x2="22" y2="22"/><path d="M10.41 10.41a2 2 0 11-2.83-2.83"/><line x1="13.5" y1="6.5" x2="14" y2="6"/><path d="M14 3H5a2 2 0 00-2 2v11"/><path d="M19 15l-3.5-3.5L12 14l-2-2"/><rect x="3" y="3" width="18" height="18" rx="2"/>`,
  'refresh':  `<polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 11-2.12-9.36L23 10"/>`,
  orders:     `<path d="M16.5 9.4l-9-5.19M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 002 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/>`,
  'upload-cloud': `<polyline points="16 16 12 12 8 16"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.39 18.39A5 5 0 0018 9h-1.26A8 8 0 103 16.3"/>`,
  'download-cloud': `<polyline points="8 17 12 21 16 17"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.88 18.09A5 5 0 0018 9h-1.26A8 8 0 103 16.29"/>`,
...
<template>
  <svg
    ...
    v-html="icons[name] ?? icons['alert-circle'] ?? ''"
    aria-hidden="true"
    class="app-icon"
  />
</template>
...
<style scoped>
.app-icon { display: inline-block; flex-shrink: 0; vertical-align: middle; }
</style>
